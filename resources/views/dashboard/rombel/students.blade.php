...
@section('title', 'Siswa Rombel ' . $rombel->name . ' | Abseen')
   ...
   <div class="pt-4 pb-2">
      <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
         <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item"><a href="/dashboard/rombel/{{ $rombel->id }}/siswa">Siswa Rombel
                  {{ $rombel->name }}</a></li>
         </ol>
      </nav>
      <div class="d-flex justify-content-between align-items-center w-100 flex-wrap">
         <h1 class="h4 mb-3 mb-lg-0">Data Siswa Rombel {{ $rombel->name }}</h1>
         <a href="/dashboard/rombel/" class="btn btn-primary">
            &leftarrow; Kembali
         </a>
      </div>
   </div>

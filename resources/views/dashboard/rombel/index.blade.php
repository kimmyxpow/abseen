   ...
   <div class="pt-4 pb-2">
      <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
         <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item"><a href="/dashboard/rombel">Rombel</a></li>
         </ol>
      </nav>
      <div class="d-flex justify-content-between align-items-center w-100 flex-wrap">
         <h1 class="h4 mb-3 mb-lg-0">Data Rombel</h1>
      </div>
   </div>
@endsection
...
@section('content')
   ...
   @if (Auth::user()->role == 'Admin')
      <div class="card border-0 shadow mb-4">
         ...
         <form action="/dashboard/rombel" method="POST" class="card-body d-flex align-items-start gap-2">
            @csrf
      ...
      <div id="card-edit" class="card border-0 shadow mb-4 {{ session()->has('status') ? 'd-block' : 'd-none' }}">
         ...
         <form action="/dashboard/rombel/{{ session()->has('status') ? session('status')->id : '' }}" id="form-crud"
               ...
               <tbody>
                  @foreach ($data as $row)
                     <tr>
                        ...
                        <td class="fw-bold">
                           @if ($row->user->count() != 0)
                              <a href="/dashboard/rombel/{{ $row->id }}/siswa">

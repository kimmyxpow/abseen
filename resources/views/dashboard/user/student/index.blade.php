      ...
      document.addEventListener("DOMContentLoaded", function() {
         ...
         document.querySelectorAll('.btn-delete').forEach(btn => {
            btn.addEventListener('click', function() {
               ...
               fetch('http://lara-absensi.test/dashboard/user/siswa/' + id, {
                     method: 'GET',
                     headers: {
                  ...
                  .then(data => {
                     document.querySelector('#modal-notification p').innerHTML =
                        `Apakah kamu yakin ingin menghapus siswa ini? Semua data yang bersangkutan dengan siswa <b>${data.name}</b> juga ini akan ikut terhapus!`;
                     document.querySelector('#form-delete').setAttribute('action',
                        '/dashboard/user/siswa/' + data.id + '/delete');

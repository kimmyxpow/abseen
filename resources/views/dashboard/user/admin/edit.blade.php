...
@section('title', 'Edit Data Admin ' . $data->name . ' | Abseen')
   ...
   <div class="pt-4 pb-2">
      <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
         <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active"><a href="/dashboard/user/admin/create">Edit Data Admin {{ $data->name }}</a>
            </li>
         </ol>
      </nav>
      <div class="d-flex justify-content-between align-items-center w-100 flex-wrap">
         <h1 class="h4 mb-3 mb-lg-0">Edit Data Admin {{ $data->name }}</h1>
...
@section('content')
   <div class="card border-0 shadow mb-4">
      ...
      <div class="card-body">
         <form action="/dashboard/user/admin/{{ $data->id }}/edit" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
            ...
            <div class="row">
               ...
               <div class="col-sm-6">
                  <div class="mb-4">
                     <label for="password">Password Baru Admin (Tidak Wajib):</label>
               ...
               <div class="col-sm-6">
                  <div class="mb-4">
                     <label for="password_confirmation">Konfirmasi Password Baru Admin (Tidak Wajib):</label>

...
@section('heading')
   <div class="pt-4 pb-2">
      ...
      <div class="d-flex justify-content-between align-items-center w-100 flex-wrap">
         <h1 class="h4 mb-3 mb-lg-0">Data Admin</h1>
         <a href="/dashboard/user/admin/create" class="btn btn-primary">
            &plus; Tambah
         </a>
      </div>
   </div>
   ...
   <div class="card border-0 shadow mb-4">
      <div class="card-header">
         <div class="input-group input-group-merge search-bar">
            ...
            <input type="text" class="form-control" id="topbarInputIconLeft" placeholder="Cari admin..."
                  ...
                  @if (count($data))
                     @foreach ($data as $row)
                        <tr>
                           ...
                           @if (Auth::user()->role == 'Admin')
                              <td>
                                 <a href="/dashboard/user/admin/{{ $row->id }}/edit" class="btn btn-warning"
                                    href="#">Edit</a>
      ...
      document.addEventListener("DOMContentLoaded", function() {
         ...
         document.querySelectorAll('.btn-delete').forEach(btn => {
            btn.addEventListener('click', function() {
               ...
               fetch('http://lara-absensi.test/dashboard/user/admin/' + id, {
                     method: 'GET',
                     headers: {
                  ...
                  .then(data => {
                     document.querySelector('#modal-notification p').innerHTML =
                        `Apakah kamu yakin ingin menghapus admin ini? Semua data yang bersangkutan dengan admin <b>${data.name}</b> juga ini akan ikut terhapus!`;
                     document.querySelector('#form-delete').setAttribute('action',
                        '/dashboard/user/admin/' + data.id + '/delete');

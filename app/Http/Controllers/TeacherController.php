...
class TeacherController extends Controller
{
    ...
    {
        return view('dashboard.user.teacher.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/user/guru')->with('success', 'Berhasil Menambah Data Baru!');
    }
    ...
    {
        return view('dashboard.user.teacher.edit', [
            'data' => $user
        ]);
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        //? Redirect ke dashboard user dengan session success
        return redirect('/dashboard/user/guru')->with('success', 'Berhasil Mengubah Data!');
    }
    ...
    public function destroy(User $user)
    {
        ...
        //? Redirect ke dashboard user dengan session success
        return redirect('/dashboard/user/guru')->with('success', 'Berhasil Menghapus Data!');
    }
}
